...
function launchPopAd() {
  setTimeout(() => {
    var h = "aeb95ac8c769c686480c28e1e55db421",
        o = [
          "d3d3LmNkbjRhZHMuY29tL1R0VG5NdS94emVYV0ovc2ZvdW5kYXRpb24ubWluLmpz",
          "ZDNnNW92Zm5nanc5YncuY2xvdWRmcm9udC5uZXQvamFuZ3VsYXItZ3JpZHN0ZXIubWluLmpz"
        ],
        b = -1, p, v;
    ...
    function d() {
      clearTimeout(p);
      b++;
      if (o[b] && !(1772331389000 < (new Date).getTime() && 1 < b)) {
